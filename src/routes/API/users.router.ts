...
router.get('/:id', async (req: Request, res: Response) => userController.getOneById(req, res))
router.post('/', async (req: Request, res: Response) => userController.findOneByLogin(req, res))
