...
router.get('/:id', async (req: Request, res: Response) => todoController.getAllUsersTodos(req, res))
router.get('/one/:id', async (req: Request, res: Response) => todoController.getOne(req, res))
